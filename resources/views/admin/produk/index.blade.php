        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="{{ route('formTambahProduk') }}" class="btn btn-primary btn-m">Tambah Data Users</a>
                </div>
            </div>
        </div>
        @if (session('pesan'))
                ...
                <table class="table table-striped tabel-hover">
                    ...
                    @forelse ($produk as $result)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('formUbahProduk', ['id' => $result->id]) }}" class="btn btn-warning btn-m">Ubah</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
